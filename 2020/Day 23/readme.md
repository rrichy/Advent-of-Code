...
The crab is going to hide your **`stars`** - one each - under the `two cups that will end up immediately clockwise of cup` _`1`_. You can have them if you predict what the labels on those cups will be when the crab is finished.
