function runIntCode(intcode, input = [], num_outputs = 0, haltStatus = [false, 0, 0]){    //array of numss haltStatus = [stopIntcode, index, relativeBase]
    let output = [];
        ...
        if(size == 3){ //jumps
            ...
            if(size == 4){
                ...
                if(op == 3){
                    ...
                    else intcode[pos[1]] = input.shift();
                    // intcode[pos[1]] = input.shift() || 0;
                } 
                else{
